...
var file_proto_message_cache_proto_rawDesc = []byte{
	...
	,
...
var (
	...
	file_proto_message_cache_proto_rawDescData = file_proto_message_cache_proto_rawDesc
)

func file_proto_message_cache_proto_rawDescGZIP() []byte {
	file_proto_message_cache_proto_rawDescOnce.Do(func() {
		file_proto_message_cache_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_message_cache_proto_rawDescData)
	})
...
func file_proto_message_cache_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_message_cache_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CacheCleanRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_message_cache_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CacheCleanResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_message_cache_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CacheProductDeleteRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_message_cache_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CacheProductDeleteResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_message_cache_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CacheSearchDeleteRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_message_cache_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CacheSearchDeleteResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_proto_message_cache_proto_rawDesc = nil
