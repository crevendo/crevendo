...
func (x *StoreOption) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StoreOption) ProtoMessage() {}

func (x *StoreOption) ProtoReflect() protoreflect.Message {
	mi := &file_proto_store_proto_msgTypes[0]
...
// Deprecated: Use StoreOption.ProtoReflect.Descriptor instead.
func (*StoreOption) Descriptor() ([]byte, []int) {
	return file_proto_store_proto_rawDescGZIP(), []int{0}
}

func (x *StoreOption) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *StoreOption) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *StoreOption) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_proto_store_proto_rawDesc = []byte{
	...
	,
...
var file_proto_store_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_store_proto_goTypes = []interface{}{
	(*StoreOption)(nil), // 0: StoreOption
}
