...
const (
	CartService_Get_FullMethodName                = "/CartService/Get"
	CartService_Create_FullMethodName             = "/CartService/Create"
	CartService_AddItem_FullMethodName            = "/CartService/AddItem"
	CartService_RemoveItem_FullMethodName         = "/CartService/RemoveItem"
	CartService_UpdateItemQuantity_FullMethodName = "/CartService/UpdateItemQuantity"
	CartService_GetOrderTotal_FullMethodName      = "/CartService/GetOrderTotal"
)
...
func (c *cartServiceClient) GetOrderTotal(ctx context.Context, in *message.CartGetMessage, opts ...grpc.CallOption) (*message.GetOrderTotalResponse, error) {
	...
	err := c.cc.Invoke(ctx, CartService_GetOrderTotal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CartService_GetOrderTotal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CartService_GetOrderTotal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
