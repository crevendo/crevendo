...
const (
	...
	AuthService_QuickLogin_FullMethodName     = "/AuthService/QuickLogin"
...
func (c *authServiceClient) QuickLogin(ctx context.Context, in *message.QuickLoginMessage, opts ...grpc.CallOption) (*message.QuickLoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_QuickLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_QuickLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_QuickLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
