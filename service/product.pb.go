...
var file_proto_service_product_proto_rawDesc = []byte{
	...
	0x64, 0x75, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xed, 0x01, 0x0a, 0x0e, 0x50,
...
var file_proto_service_product_proto_goTypes = []interface{}{
	...
	(*message.ProductGetResponse)(nil),    // 4: ProductGetResponse
	(*message.ProductListResponse)(nil),   // 5: ProductListResponse
	(*message.ProductUpdateResponse)(nil), // 6: ProductUpdateResponse
	(*message.ProductCreateResponse)(nil), // 7: ProductCreateResponse
}
var file_proto_service_product_proto_depIdxs = []int32{
	...
	4, // 4: ProductService.Get:output_type -> ProductGetResponse
	5, // 5: ProductService.List:output_type -> ProductListResponse
	6, // 6: ProductService.Update:output_type -> ProductUpdateResponse
	7, // 7: ProductService.Create:output_type -> ProductCreateResponse
